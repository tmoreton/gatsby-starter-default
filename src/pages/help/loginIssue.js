...
const LoginIssue = () => {
  ...
  const [categoryName] = useState('Login Issue')
  ...
  return (
    <Layout>
      <div className="col-md-8 mx-auto text-center">
        ...
        <p>A sales agent is unable to login to the Inspire enrollment application</p>
...
export default connect(mapDispatchToProps) (LoginIssue)
